"""
WAGF Irrigation Experiment v4 -- Comprehensive Analysis
========================================================
...
def print_report(records, agent_meta, reflections):
    ...
    print("=" * 72)
    print("  WAGF Irrigation Experiment v4 -- Comprehensive Analysis Report")
    print("=" * 72)
...
def make_figure(records, agent_meta, reflections):
    ...
    # ============================================================
    fig.suptitle(
        f"WAGF Irrigation Experiment v4 -- Gemma3 4B, 78 Districts, "
