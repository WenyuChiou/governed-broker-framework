...
Run: pytest cognitive_governance/tests/test_integration.py -v
"""
...
class TestEndToEndFlow:
    ...
    def test_all_imports_work(self):
        ...
        from cognitive_governance.v1_prototype import (
            PolicyRule,
            GovernanceTrace,
        ...
        from cognitive_governance.v1_prototype.core.engine import PolicyEngine
        from cognitive_governance.v1_prototype.core.calibrator import EntropyCalibrator as CoreCalibrator
    ...
    def test_demo_script_runs(self):
        result = subprocess.run(
            [sys.executable, "cognitive_governance/demo_sdk_usage.py"],
            capture_output=True,
            text=True,
        )
