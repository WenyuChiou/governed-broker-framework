...
from cognitive_governance.v1_prototype.types import GovernanceTrace, PolicyRule


def test_governed_agent_passthrough():
    from cognitive_governance.v1_prototype.core.wrapper import (
        GovernedAgent,
...
def test_governed_agent_state_extraction():
    from cognitive_governance.v1_prototype.core.wrapper import GovernedAgent, CognitiveInterceptor
...
def test_audit_writer_creates_file(tmp_path):
    from cognitive_governance.v1_prototype.audit.replay import AuditWriter
...
def test_audit_reader_filters(tmp_path):
    from cognitive_governance.v1_prototype.audit.replay import AuditWriter, AuditReader
