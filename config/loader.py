...
class DomainConfigLoader:
    ...
    Usage:
        ...
        validators = loader.get_validators()
    """
    ...
    @classmethod
    def from_file(cls, config_path: str | Path) -> "DomainConfigLoader":
...
def load_domain(domain_name: str, config_dir: str | Path = None) -> DomainConfigLoader:
    """
    ...
    if config_dir is None:
        # Default: look in governed_broker_framework/config/domains/
        config_dir = Path(__file__).parent / "domains"
